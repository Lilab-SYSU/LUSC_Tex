...
homePage<-    box(width = 12,
    fluidRow(column(width=1),
             column(
              ...
              h3(p(strong("Althrough immunotherapy has revolutionized the treatment of lung squamous carcinoma, a significant proportion of patients which had high PDL1 expression showed resistance to immnotherapy. 
                           Based on gene expression profiles, we used virtual microdissection method to deconvolute the expression patterns and identify an immunosuppressive subtype which showed potential resistance to immune checkpoint therapy. Then we defined this subtype Exhausted Immune class and developed a Exhausted Immune classifier to predict patients belonging to this class")),
    ...
    fluidRow(column(width=1),
             column(
               h3(p(" This application consist of seven functional modules including signature expression, exhausted immune classifier, somatic mutation, microRNA, methylation, clinic and chemotherapy drugs. The dedailed usage of each module was described as below.", 
